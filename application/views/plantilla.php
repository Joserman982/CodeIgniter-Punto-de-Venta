...
<head>
  ...
  <link rel="stylesheet" href="application/views/plugins/iCheck/all.css">

   <!-- Daterange picker -->
  <link rel="stylesheet" href="application/views/bower_components/bootstrap-daterangepicker/daterangepicker.css">

  <!-- Morris chart -->
  <link rel="stylesheet" href="application/views/bower_components/morris.js/morris.css">
  ...
  <!-- iCheck 1.0.1 -->
  <script src="application/views/plugins/iCheck/icheck.min.js"></script>

  <!-- InputMask -->
  <script src="application/views/plugins/input-mask/jquery.inputmask.js"></script>
  <script src="application/views/plugins/input-mask/jquery.inputmask.date.extensions.js"></script>
  <script src="application/views/plugins/input-mask/jquery.inputmask.extensions.js"></script>

  <!-- jQuery Number -->
  <script src="application/views/plugins/jqueryNumber/jquerynumber.min.js"></script>

  <!-- daterangepicker http://www.daterangepicker.com/-->
  <script src="application/views/bower_components/moment/min/moment.min.js"></script>
  <script src="application/views/bower_components/bootstrap-daterangepicker/daterangepicker.js"></script>

  <!-- Morris.js charts http://morrisjs.github.io/morris.js/-->
  <script src="application/views/bower_components/raphael/raphael.min.js"></script>
  <script src="application/views/bower_components/morris.js/morris.min.js"></script>

  <!-- ChartJS http://www.chartjs.org/-->
  <script src="application/views/bower_components/Chart.js/Chart.js"></script>
...
<script src="application/views/js/categorias.js"></script>
<script src="application/views/js/productos.js"></script>
<script src="application/views/js/clientes.js"></script>
<script src="application/views/js/ventas.js"></script>
<script src="application/views/js/reportes.js"></script>
