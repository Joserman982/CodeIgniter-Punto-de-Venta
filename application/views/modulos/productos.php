    ...
    <div class="box">
      ...
      <!--   <tbody>
        ...
        foreach ($productos as $key => $value) {
          ...
          echo '<tr>
                  <td>'.($key+1).'</td>
                  <td><img src="application/views/img/productos/default/anonymous.png" class="img-thumbnail" width="40px"></td>
                  <td>'.$value["codigo"].'</td>
          ...
          <div class="box-body">
            ...
            <!-- ENTRADA PARA SUBIR FOTO -->
             ...
             <div class="form-group">
              ...
              <img src="application/views/img/productos/default/anonymous.png" class="img-thumbnail previsualizar" width="100px">
